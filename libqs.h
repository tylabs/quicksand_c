...
//  Copyright 2016, 2017 tylabs.com
//
...
char *QUICKSAND_VERSION = "01.06.028";
...
#define QUICKSAND_MAX_FACTORS 1024
#define QUICKSAND_MAX_SLICES 15
int QUICKSAND_FACTORS = 1024;
int QUICKSAND_SLICES = 15;
int QUICKSAND_LOOKAHEAD = 0;
int QUICKSAND_BRUTE = 0;
int QUICKSAND_MEAN_EXEC = 9999999;
...
int QUICKSAND_ARR_FACTORS[] = {1024, 512, 256, 128, 64, 32, 16, 8, 7, 6, 5, 4, 3, 2, 1};

struct a_crypto1024 {
    unsigned char a[QUICKSAND_MAX_FACTORS][257];
    
    unsigned char b[QUICKSAND_MAX_SLICES][QUICKSAND_MAX_FACTORS+1];
    
    int c[QUICKSAND_MAX_SLICES];
...
#ifdef REL_FULL
void quicksandIngestKilobyte(struct a_crypto1024*, unsigned char*);

struct a_crypto1024* quicksandInitSpectralArray();

void quicksandRefactorArray(struct a_crypto1024*);
